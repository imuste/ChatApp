...
void writeEverything(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client19");
        ...
        strcpy(header2.msgSource, "client19");
        ...
        strcpy(header3.msgSource, "client19");
        header3.msgSource[sizeof(header3.msgSource) - 1] = '\0';
        strcpy(header3.msgDest, "client20");
        header3.msgDest[sizeof(header3.msgDest) - 1] = '\0';
        header3.contentLength = htonl(32);
        header3.msgID = htonl(1);
        int msgSize1 = 32;
        char *chat1 = malloc(msgSize1);
        strcpy(chat1, "Hello this is message 1 for you!");
        ...
        int fullMessageSize = totalSize1 + totalSize2 + sizeof(msgHeader) + sizeof(msgHeader);
