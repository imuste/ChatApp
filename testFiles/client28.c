...
void writeClientList(int clientSD);
...
{       
        ...
        //writes in 2 parts with 3 seconds sleep in between
        writeClientList(clientSD);
...
void writeHello(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client28");
...
void writeClientList(int clientSD)
{
        ...
        strcpy(header2.msgSource, "client28");
...
void writeExit(int clientSD)
{
        ...
        strcpy(header3.msgSource, "client28");
