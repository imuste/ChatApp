...
void writeHello(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client51");
...
void writeChat1(int clientSD)
{
        ...
        // strcpy(header2.msgSource, "client51");
        // header2.msgSource[sizeof(header2.msgSource) - 1] = '\0';
        // strcpy(header2.msgDest, "client50");
...
void writeExit(int clientSD)
{
        ...
        strcpy(header3.msgSource, "client51");
