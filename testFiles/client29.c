...
{       
        ...
        //read CHAT from client30
        readChat(clientSD);

        //write CHAT back to client30
        writeChat1(clientSD);
...
void writeHello(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client29");
        ...
        int returnVal = write(clientSD, (char *)&header1, 3);
        sleep(10);
        returnVal = write(clientSD, (char *)&header1 + 3, 47);
        assert(returnVal != -1);
}
...
void writeChat1(int clientSD)
{
        ...
        strcpy(header2.msgSource, "client29");
        header2.msgSource[sizeof(header2.msgSource) - 1] = '\0';
        strcpy(header2.msgDest, "client30");
        ...
        strcpy(chat, "Thank you for your message client30!");
...
void writeExit(int clientSD)
{
        ...
        int returnVal = write(clientSD, (char *)&header2, sizeof(msgHeader));
        assert(returnVal != -1);
}
