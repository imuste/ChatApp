...
{       
        for (int i = 0; i < 45; i++) {
                ...
                if (i < 44) {
                        ...
                        if (returnVal == 0) {
                                printf("client %d was successfully removed\n", clientSD + 10);
                        }
                }
...
void writeHello(int clientSD)
{
        ...
        // strcpy(header1.msgSource, "client%i", clientSD);
        snprintf(header1.msgSource, sizeof(header1.msgSource), "client%i", (clientSD + 10));
...
void writeExit(int clientSD)
{
        ...
        // strcpy(header2.msgSource, "client1");
        snprintf(header2.msgSource, sizeof(header2.msgSource), "client%i", (clientSD + 10));
