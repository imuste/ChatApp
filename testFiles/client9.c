...
void writeHello(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client9");
...
void writeChat1(int clientSD)
{
        ...
        strcpy(header2.msgSource, "client9");
        header2.msgSource[sizeof(header2.msgSource) - 1] = '\0';
        strcpy(header2.msgDest, "client10");
...
void writeChat2(int clientSD)
{
        ...
        int returnVal = write(clientSD, totalmessage, 3);
        assert(returnVal != -1);
        sleep(1);
        returnVal = write(clientSD, totalmessage + 3, 40);
        assert(returnVal != -1);
        sleep(1);
        returnVal = write(clientSD, totalmessage + 43, totalSize - 43);
        assert(returnVal != -1);
}
...
void writeExit(int clientSD)
{
        ...
        strcpy(header3.msgSource, "client9");
