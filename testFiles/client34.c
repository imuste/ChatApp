...
void writeHello(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client34");
...
void writeChat1(int clientSD)
{
        ...
        strcpy(header2.msgSource, "client34");
        header2.msgSource[sizeof(header2.msgSource) - 1] = '\0';
        strcpy(header2.msgDest, "clientZ2");
        ...
        strcpy(chat, "Hello, how are you doing, this is a message from client34.");
...
void writeExit(int clientSD)
{
        ...
        strcpy(header3.msgSource, "client34");
