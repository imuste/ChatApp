...
void writeHello(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client26");
...
void writeChat1(int clientSD)
{
        ...
        strcpy(header2.msgSource, "client26");
        header2.msgSource[sizeof(header2.msgSource) - 1] = '\0';
        strcpy(header2.msgDest, "client25");
        ...
        strcpy(chat, "Thank you for your super super long message!");
...
void writeExit(int clientSD)
{
        ...
        strcpy(header3.msgSource, "client26");
