...
{       
        ...
        strcpy(header1.msgSource, "client74");
        ...
        strcpy(header2.msgSource, "client74");
        ...
        char *overlappingMessage = malloc(96);
        assert(overlappingMessage != NULL);

        memcpy(overlappingMessage, (char *)&header1 + 3, 47);
        memcpy(overlappingMessage + 47, (char *)&header2, 49);

        returnVal = write(clientSD, overlappingMessage, 96);
        assert(returnVal != -1);
        ...
        sleep(1);
        returnVal = write(clientSD, (char *)&header2 + 49, 1);
        assert(returnVal != -1);
