...
void writeHello(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client14");
...
void writeChat(int clientSD)
{
        ...
        strcpy(header2.msgSource, "client14");
        header2.msgSource[sizeof(header2.msgSource) - 1] = '\0';
        strcpy(header2.msgDest, "client13");
        ...
        strcpy(chat, "Hello, how are you doing, this is a message from client14.");
