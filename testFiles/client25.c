...
void writeHello(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client25");
...
void writeChat1(int clientSD)
{
        ...
        // int totalFileSize = fileSize + 1;

        // char *fileContents = malloc(totalFileSize);
        ...
        strcpy(header2.msgSource, "client25");
        header2.msgSource[sizeof(header2.msgSource) - 1] = '\0';
        strcpy(header2.msgDest, "client26");
        header2.msgDest[sizeof(header2.msgDest) - 1] = '\0';
        header2.contentLength = htonl(fileSize);
        header2.msgID = htonl(1);

        int totalSize = fileSize + sizeof(msgHeader);
        char *totalmessage = malloc(totalSize);
        memcpy(totalmessage, &header2, sizeof(header2));
        memcpy(totalmessage + sizeof(header2), fileContents, fileSize);
...
void writeExit(int clientSD)
{
        ...
        strcpy(header3.msgSource, "client25");
