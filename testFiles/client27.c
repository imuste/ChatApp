...
void writeHello(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client27");
...
void writeChat1(int clientSD)
{
        ...
        strcpy(header2.msgSource, "client27");
        header2.msgSource[sizeof(header2.msgSource) - 1] = '\0';
        strcpy(header2.msgDest, "clientX");
        header2.msgDest[sizeof(header2.msgDest) - 1] = '\0';
        header2.contentLength = htonl(42);
        header2.msgID = htonl(4);

        int msgSize = 42;
        char *chat = malloc(msgSize);
        strcpy(chat, "Sending a message to a non-Existent client");
...
void writeExit(int clientSD)
{
        ...
        strcpy(header3.msgSource, "client27");
