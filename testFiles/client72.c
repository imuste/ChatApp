...
void writeHello(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client72");
...
void writeChat1(int clientSD)
{
        ...
        strcpy(header2.msgSource, "client72");
        header2.msgSource[sizeof(header2.msgSource) - 1] = '\0';
        strcpy(header2.msgDest, "client70");
        ...
        strcpy(chat, "Hello, how are you doing, this is a message from client 6.");
...
void writeExit(int clientSD)
{
        ...
        strcpy(header3.msgSource, "client72");
