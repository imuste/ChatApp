...
void writeClientListPt1(int clientSD);
void readChat(int clientSD);
void writeClientListPt2(int clientSD);
...
{       
        ...
        //write part of CLIENT_LIST_REQ to socket
        writeClientListPt1(clientSD);

        //read CHAT MSG from the socket
        //Hello, how are you doing, this is a message from client 14
        readChat(clientSD);

        //write part of CLIENT_LIST_REQ to socket
        writeClientListPt2(clientSD);
...
void writeHello(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client13");
...
void writeClientListPt1(int clientSD)
{
        ...
        strcpy(header2.msgSource, "client13");
        ...
        int returnVal = write(clientSD, (char *)&header2, 13);
        assert(returnVal != -1);
}
...
void writeClientListPt2(int clientSD)
{
        ...
        header2.contentLength = htonl(0);
        header2.msgID = htonl(0);
        int returnVal = write(clientSD, (char *)&header2 + 13, 37);
        assert(returnVal != -1);
}
...
void writeExit(int clientSD)
{
        ...
        strcpy(header3.msgSource, "client13");
