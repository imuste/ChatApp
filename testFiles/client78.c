...
void writeHello(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client78");
        ...
        strcpy(header2.msgSource, "client78");
        header2.msgSource[sizeof(header2.msgSource) - 1] = '\0';
        strcpy(header2.msgDest, "client79");
        ...
        char *partialMessage = malloc(119);
        memcpy(partialMessage, (char *)&header1, sizeof(msgHeader));
        memcpy(partialMessage + sizeof(header1), totalmessage, 69);

        int returnVal = write(clientSD, partialMessage, 119);
        assert(returnVal != -1);
...
void writeExit(int clientSD)
{
        ...
        strcpy(header3.msgSource, "client78");
