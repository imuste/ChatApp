...
void writeHello(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client23");
...
void writeChatToClient24(int clientSD)
{
        ...
        strcpy(header2.msgSource, "client23");
        ...
        strcpy(chat, "A great message from client23 to client24");
...
void writeChatToClient21(int clientSD)
{
        ...
        int msgSize = 41;
        char *chat = malloc(msgSize);
        strcpy(chat, "This is client23 messaging back client 21");
...
void writeExit(int clientSD)
{
        ...
        strcpy(header3.msgSource, "client23");
