...
void writeHello(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client40");
...
void writeExit(int clientSD)
{
        ...
        strcpy(header3.msgSource, "client40");
