...
void writeHello(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client46");
...
void readChat(int clientSD)
{
        ...
        char *message1 = malloc(46);
        memcpy(&receivedHeader1, clientListBuffer, sizeof(msgHeader));
        memcpy(message1, clientListBuffer + 50, 46);
        ...
        // memcpy(&receivedHeader2, clientListBuffer + 96, sizeof(msgHeader));
        // memcpy(message2, clientListBuffer + 146, 13);
...
void writeExit(int clientSD)
{
        ...
        strcpy(header3.msgSource, "client46");
