...
void writeHello(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client49");
...
void writeChat1(int clientSD)
{
        ...
        strcpy(header2.msgSource, "client49");
        header2.msgSource[sizeof(header2.msgSource) - 1] = '\0';
        strcpy(header2.msgDest, "client38");
        ...
        strcpy(chat, "Hello there, this is a messag that is very much invalid");
