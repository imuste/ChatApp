...
{       
        ...
        //write CHAT in 3 parts to client36
        writeChat1(clientSD);

        //read could not deliver error
        readError(clientSD);
...
void writeHello(int clientSD)
{
        ...
        strcpy(header1.msgSource, "client35");
...
void writeChat1(int clientSD)
{
        ...
        strcpy(header2.msgSource, "client35");
        header2.msgSource[sizeof(header2.msgSource) - 1] = '\0';
        strcpy(header2.msgDest, "client36");
        header2.msgDest[sizeof(header2.msgDest) - 1] = '\0';
        header2.contentLength = htonl(58);
        header2.msgID = htonl(8);

        int msgSize = 58;
        char *chat = malloc(msgSize);
        strcpy(chat, "Hello, how are you doing, this is a message from client35.");
...
void writeExit(int clientSD)
{
        ...
        strcpy(header3.msgSource, "client35");
